...
public class InMemoryStorageTest {
	...
	@Test
	public void testClear_withSession() {
		long cachedDate = System.currentTimeMillis();
		Storage storage = getStorage(cachedDate);
	...
	@Test
	public void testClear_withSessionAndKey() {
		long cachedDate = System.currentTimeMillis();
		Storage storage = getStorage(cachedDate);
	...
	private Storage getStorage(long cachedDate) {
		Storage storage = new InMemoryStorage(false);
